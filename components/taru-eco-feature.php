<div class="col-md-12 jumbotron rounded-0 mt-3 bg-white">
	<h3 class="text-center mb-3" data-aos="fade-down" style="margin-top: -30px;">OTHER VIDEO</h3>
	<div class="row">
		<div class="col-md-4" align="center" data-aos="fade-down" data-aos-delay="200">
		...
		<div class="col-md-4" align="center" data-aos="fade-down" data-aos-delay="600">
			<a data-fancybox="images-3" href="https://www.youtube.com/watch?v=_7CgCAc1mMg " style="text-decoration: none;">
			<img src="https://res.cloudinary.com/dansprogramming/image/upload/v1610350948/com-3.png" width="100px;" class="img-fluid rounded-circle bg-eco-feature">
  			<h6 class="text-white mt-2" style="background-color: #038A7C; padding: 10px; width: 40%">Parahyangan Golf</h6>
  			</a>
		</div>		
	</div>
</div>