			...
			<div id="myCarousel" class="carousel slide" data-interval="false">
				<div class="carousel-inner">
					<div class="carousel-item active" data-slide-number="0">
						<img src="assets/img/gallery/sky-top-1.jpg" class="d-block w-100" alt="..."  data-type="image" data-toggle="lightbox" >
					</div>
					<div class="carousel-item" data-slide-number="1">
						<img src="assets/img/gallery/sky-top-2.jpg" class="d-block w-100" alt="..." data-type="image" data-toggle="lightbox" >
					</div>
					<div class="carousel-item" data-slide-number="2">
						<img src="assets/img/gallery/sky-top-3.jpg" class="d-block w-100" alt="..." data-type="image" data-toggle="lightbox" >
					</div>    
					...
					<div class="carousel-item active">
						<div class="row mx-auto justify-content-center">
							<div id="carousel-selector-0" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="0">
								<img src="assets/img/gallery/sky-top-1.jpg" class="img-fluid" alt="...">
							</div>
							<div id="carousel-selector-1" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="1">
								<img src="assets/img/gallery/sky-top-2.jpg" class="img-fluid" alt="...">
							</div>
							<div id="carousel-selector-2" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="2">
								<img src="assets/img/gallery/sky-top-3.jpg" class="img-fluid" alt="...">
							</div>
